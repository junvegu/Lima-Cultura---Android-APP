...
public class PlacesFragment extends BaseFragment implements PlacesContract.View {
    ...
    private PlaceAdapter eventsAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new PlacesPresenter(getContext(),this);
    ...
    @Override
    public void setPresenter(@NonNull PlacesContract.Presenter presenter) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        eventsAdapter  = new PlaceAdapter(getContext(), new ArrayList<PlaceModel>(), (CommunicateContactsPresenter) mPresenter);
    ...
    public void showEvents(ArrayList<PlaceModel> eventModels) {
        if (this.rvEvents != null && eventsAdapter != null) {
            ...
            eventsAdapter = new PlaceAdapter(getContext(), eventModels, (CommunicateContactsPresenter) mPresenter);
            rvEvents.setAdapter(eventsAdapter);
