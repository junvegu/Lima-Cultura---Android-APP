 ...
 */
public class MyPlacesPresenter implements MyPlacesContract.Presenter, CommunicateContactsPresenter {

    private final MyPlacesContract.View mView;
    private final Context mContext;
    private SessionManager sessionManager;
    private boolean mFirstLoad = true;

    public MyPlacesPresenter(@NonNull Context mContext,
                             @NonNull MyPlacesContract.View mView) {
    ...
    public void loadPlace(String token) {
        ...
        Call<TrackPlaceModel> call = couponRequest.getPlacesFavorit("Token " +
                token);
