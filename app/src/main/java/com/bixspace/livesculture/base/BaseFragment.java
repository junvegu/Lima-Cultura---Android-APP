...
public abstract class BaseFragment extends Fragment {
    ...
    public void showRedMessage(Activity activity, String msg) {
        new Restaurant(activity, msg, Snackbar.LENGTH_LONG)
                .setBackgroundColor(getResources().getColor(R.color.error_red))
                .show();
    }
